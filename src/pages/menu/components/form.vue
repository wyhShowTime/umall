    ...
    <el-dialog :title="info.title" :visible.sync="info.isshow" @closed="closed">
      <el-form :model="form" :rules="rules" ref="formName">
        ...
        <el-form-item
          ...
          prop="icon"
        >
          <el-select v-model="form.icon" placeholder="请选择" prop='icon'>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        pid:[{required:true,message:'这个也是必选奥'}],
        url:[{required:true,message:'这个也得必选'}],
        icon:[{required:true,message:'这个也得选'}]
      },
      icons: [
        "el-icon-s-tools",
        "el-icon-user-solid",
